...
def calculate_days_left(birth_month, birth_year, target_age):
...
days_left_60 = calculate_days_left(birth_month, birth_year, 60)
if days_left_60 > 0:
...
days_left_75 = calculate_days_left(birth_month, birth_year, 75)
if days_left_75 > 0:
